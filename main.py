...
from controller.utils.validatorDisciplines import assessPopulation, createRoulette, selectChromosomesInRoulette, crossover
...
rollette: Population = createRoulette(currentPopulation)

selectedChromosomesInRoulette: Population = selectChromosomesInRoulette(rollette)


# crossover(selectedChromosomesInRoulette)